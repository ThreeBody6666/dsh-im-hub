...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const FIELD_GROUPS = [
			...
			},
			{
				...
				fields: [
					...
					{ field: "telegramToken", spec: secretField("telegramToken"), kind: "secret", labelKey: "f.telegramToken", hintKey: "f.telegramTokenHint" },
					{ field: "telegramAllowedUserIds", spec: textField("telegramAllowedUserIds"), kind: "text", labelKey: "f.telegramAllowedUserIds", hintKey: "f.allowedUserIdsHint" }
				]
			},
			{
				key: "feishu",
				fields: [
					...
					{ field: "feishuAppId", spec: textField("feishuAppId"), kind: "text", labelKey: "f.feishuAppId", hintKey: "f.feishuAppIdHint" },
					{ field: "feishuAppSecret", spec: secretField("feishuAppSecret"), kind: "secret", labelKey: "f.feishuAppSecret", hintKey: "f.secretHint" },
					{ field: "feishuAllowedUserIds", spec: textField("feishuAllowedUserIds"), kind: "text", labelKey: "f.feishuAllowedUserIds", hintKey: "f.allowedUserIdsHint" }
				]
			},
			{
				key: "lark",
				fields: [
					...
					{ field: "larkAppId", spec: textField("larkAppId"), kind: "text", labelKey: "f.larkAppId", hintKey: "f.feishuAppIdHint" },
					{ field: "larkAppSecret", spec: secretField("larkAppSecret"), kind: "secret", labelKey: "f.larkAppSecret", hintKey: "f.secretHint" },
					{ field: "larkAllowedUserIds", spec: textField("larkAllowedUserIds"), kind: "text", labelKey: "f.larkAllowedUserIds", hintKey: "f.allowedUserIdsHint" }
				]
			},
			{
				key: "wecom",
				fields: [
					...
					{ field: "wecomCorpId", spec: textField("wecomCorpId"), kind: "text", labelKey: "f.wecomCorpId", hintKey: "f.wecomCorpIdHint" },
					{ field: "wecomCorpSecret", spec: secretField("wecomCorpSecret"), kind: "secret", labelKey: "f.wecomCorpSecret", hintKey: "f.secretHint" },
					{ field: "wecomAgentId", spec: textField("wecomAgentId"), kind: "text", labelKey: "f.wecomAgentId", hintKey: "f.wecomAgentIdHint" },
					{ field: "wecomToken", spec: secretField("wecomToken"), kind: "secret", labelKey: "f.wecomToken", hintKey: "f.secretHint" },
					{ field: "wecomEncodingAesKey", spec: secretField("wecomEncodingAesKey"), kind: "secret", labelKey: "f.wecomEncodingAesKey", hintKey: "f.secretHint" },
					{ field: "wecomAllowedUserIds", spec: textField("wecomAllowedUserIds"), kind: "text", labelKey: "f.wecomAllowedUserIds", hintKey: "f.allowedUserIdsHint" }
				]
			},
			{
				key: "mock",
				fields: [
					...
					{ field: "mockPort", spec: numberField("mockPort"), kind: "number", labelKey: "f.mockPort", hintKey: "f.mockPortHint" }
				]
			},
			{
				key: "agent",
				fields: [
					{ field: "agentCwd", spec: textField("agentCwd"), kind: "text", labelKey: "f.agentCwd", hintKey: "f.agentCwdHint" },
					{ field: "agentProvider", spec: textField("agentProvider"), kind: "text", labelKey: "f.agentProvider", hintKey: "f.agentProviderHint" },
					{ field: "agentModel", spec: textField("agentModel"), kind: "text", labelKey: "f.agentModel", hintKey: "f.agentModelHint" },
					{ field: "agentMaxMessageLength", spec: numberField("agentMaxMessageLength"), kind: "number", labelKey: "f.agentMaxMessageLength", hintKey: "f.agentMaxMessageLengthHint" }
				]
			},
			{
				key: "http",
				fields: [
					{ field: "httpHost", spec: textField("httpHost"), kind: "text", labelKey: "f.httpHost", hintKey: "f.httpHostHint" },
					{ field: "httpPort", spec: numberField("httpPort"), kind: "number", labelKey: "f.httpPort", hintKey: "f.httpPortHint" }
				]
			}
		];
		...
		function Field(props) {
			const { spec, kind, t, fieldProps, state, onEdit, onReset } = props;
			const common = {
		 ...
		 */
		function apply(ctx) {
			ctx.effect(() => ctx.locale.register(NS, { en, zh }), "dsh-im-hub: dictionaries");
